    ...
    return (
        <div className="min-h-[calc(100vh-80px)] bg-gray-50 dark:bg-[#0f1115] flex items-center justify-center p-4 transition-colors">
            <div className="max-w-md w-full bg-white dark:bg-[#161b22] rounded-3xl shadow-sm border border-gray-200 dark:border-[#21262d] p-10">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm text-center mb-6">Enter your email and we'll send you a link to reset your password.</p>
                ...
                <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
                    Back to <Link to="/signin" className="text-indigo-600 dark:text-indigo-400 hover:underline">Sign In</Link>
                </p>
            </div>
        </div>
    );
